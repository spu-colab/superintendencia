...
class Permissao extends Model
{
    ...
    public const DEMANDA_PROCEDIMENTO_CADASTRAR = "DEMANDA_PROCEDIMENTO_CADASTRAR";
    public const DEMANDA_ORGAO_CADASTRAR = "DEMANDA_ORGAO_CADASTRAR";
    public const DEMANDA_AUTOR_CADASTRAR = "DEMANDA_AUTOR_CADASTRAR";
